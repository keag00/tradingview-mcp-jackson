...
import * as core from "../../core/prop_scalper_alert.js";

register("prop-scalper-alert", {
  description:
    "Watch the Prop Firm Scalper strategy on your symbol list and notify you (Pushover) the moment it enters a real trade",
  subcommands: new Map([
    [
      "check",
      {
        ...
        options: {
          symbols: {
            ...
            short: "s",
            description:
              "Comma-separated symbol list (default: $PROP_SCALPER_ALERT_SYMBOLS env var, or CME_MINI:ES1!,CME_MINI:NQ1!)",
          },
          "dry-run": {
            type: "boolean",
            description:
