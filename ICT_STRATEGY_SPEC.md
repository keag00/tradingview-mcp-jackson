...
| Previous Day/Week High/Low (PDH/PDL/PWH/PWL) | ✅ v1 (2026-07-15) | Non-repainting via `request.security(..., "D"/"W", [high[1], low[1]], lookahead=barmerge.lookahead_off)` — always reads the last *completed* day/week. Silver dashed lines for day, blue dotted for week. Toggle via `showPDHL` / `showPWHL`. |
